...
### G. Цикл, untrusted і трейс — `npm run try-loop` (33 перевірки)
...
- [ ] згода виконує саме відкладену дію, дозвіл записується в `run.approved`
...
### J. Планувальник — `npm run try-watch` (30 перевірок)
